...
import 'dart:async';
import 'RentalHistory.dart';
import 'package:firebase_database/firebase_database.dart';

class ItemRequest1 extends StatefulWidget{
  State<StatefulWidget> createState(){
    return MyApp1State();
  }
}
class MyApp1State extends State<ItemRequest1> {

  StreamSubscription _subscriptionTodo;

  String _name = "Bicycle";
  String _location = "Dhahran/KFUPM";
  String _decription = "Bicycle to use in touring various places";
  ...
  //  FirebaseTodos.getTodo("-KriJ8Sg4lWIoNswKWc4").then(_updateTodo);
    FirebaseTodos.getTodoStream("deHPdJNYm582VcJSRx5w", _updateTodo)
  ...
  void _showToast(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new RentalHistory()),
    );
      ...
      child: new Column(
        children: <Widget>[
          ...
          new ListTile(
            title: new Text("From : "
              , style: new TextStyle(fontWeight: FontWeight.w400),),
            subtitle: new Text("6/12/2018"),
            leading: new Icon(Icons.date_range),
          ),
          new ListTile(
            title: new Text("To : "
              , style: new TextStyle(fontWeight: FontWeight.w400),),
            subtitle: new Text("7/12/2018"),
            leading: new Icon(Icons.date_range),
          ),
          new ListTile(
          ...
          new RaisedButton(
              child: new Text(
                  'Accept Request', style: new TextStyle(fontSize: 20.0)),
              color: Colors.greenAccent,
              onPressed: _showSnackBar),
          new RaisedButton(
              child: new Text(
                  'Reject Request', style: new TextStyle(fontSize: 20.0)),
              color: Colors.red,
...
class Todo {
  ...
  Todo.fromJson(this.key, Map data) {
    ...
    rate = data['rate'];
    if (name == null && location == null && decription == null &&
        price == null && category == null && rate == null) {
      name = '';
      location = '';
      decription = '';
      price = 0.0;
